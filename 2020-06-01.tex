...
«Introduction aux mathématiques formalisées»} par Patrick Massot, prof
d'université en mathématiques à Orsay
\end{frame}
...
\item
  besoins du métier
\item
  approche scientifique Formation interdisciplinaire donc équilibre
  entre:
\item
