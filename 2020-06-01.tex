...
Supérieur & Le raisonnement mathématique avec LEAN\tabularnewline
\bottomrule
\end{longtable}
\end{frame}
...
\centering Initiation à l'addition et à la multiplication

\par
\end{frame}

\begin{frame}{Impression 3D}
\protect\hypertarget{impression-3d}{}
...
\begin{frame}{Impression 3D}
\protect\hypertarget{impression-3d-1}{}
...
\begin{frame}{Raisonnement mathématique avec LEAN}
\protect\hypertarget{raisonnement-mathuxe9matique-avec-lean}{}
LEAN: un assistant de preuves (L\(∃∀\)N)
...
par Patrick Massot,\\
professeur en mathématiques à Orsay
...
\centering Démonstration rédigée sur papier
...
\item
  s'assurer d'une maîtrise des mathématiques fondamentales
\item
  former à un enseignement des mathématiques\\

  qui aident à comprendre le monde
\end{itemize}
\end{frame}
...
\begin{frame}{Liens entre mon parcours et la formation des enseignants}
\protect\hypertarget{liens-entre-mon-parcours-et-la-formation-des-enseignants}{}
\begin{longtable}[]{@{}ll@{}}
\toprule
\endhead
...
Impression 3D\strut
\end{minipage} & \begin{minipage}[t]{0.70\columnwidth}\raggedright
Conception et impression 3D en classe\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.24\columnwidth}\raggedright
\strut
\end{minipage} & \begin{minipage}[t]{0.70\columnwidth}\raggedright
...
peuvent bénéficier d'une collaboration dans Sfere au-delà de l'ADEF,\\
en particulier avec l'I2M et l'IREM de Marseille.
\end{frame}
...
2014: Médiation scientifique et plateformes de partage\\
...
\item
  ...
  \item
    ...
    et le développement de la personne, 2018
  \end{itemize}
\item
...
Une nouvelle exposition Imaginary à Marseille\\
