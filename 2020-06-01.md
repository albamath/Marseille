...
\centering![](img/yupanas.png){width=68%}\par

\centering Initiation à l'addition et à la multiplication\par
...
## Raisonnement mathématique avec LEAN
...
\centering ![](img/copie-exemple.png){width=50%}\par
\footnotesize
\centering Démonstration rédigée sur papier\par
...
## Liens entre mon parcours et la formation des enseignants

|||
|-------------------|--------------------------------------------------------|
|Géométrie et systèmes dynamiques|Création de parcours de recherche pour les élèves|
|||
|Impression 3D|Conception et impression 3D en classe|
|||
...
\centering ![](img/ampiric_03.JPG)\par

\footnotesize
\centering Extrait de la présentation d'AMPIRIC de janvier 2020 (Jacques Ginestié)
...
- Rencontre interrogeant la médiation, ses usages et ses effets
    - suite d'un projet de Sfere: cartographie de la relation entre\
      ...
      l'éducation, la médiation, les expériences artistique et scientifique\
...
![](img/vieux-port-alba.jpg){width=93%}
