...
\centering![](img/yupanas.png){width=80%}\par
...
\centering![](img/akiyama-harris.jpg){width=78%}\par
...
Données : [cours «Introduction aux mathématiques formalisées»](https://www.math.u-psud.fr/~pmassot/enseignement/math114/) en L1 Math-Info à la faculté des Sciences d'Orsay.

\strut\hfill![](img/screenshot-lean.png)
...
Ces objets peuvent devenir ensuite des instruments dans des situations d'enseignement
-apprentissage. 
...
|Accéssibilité|Créer des documents accessibles pour les élèves        |
|             |Prise en compte de la fracture numérique               |
|Esprit maker |L'armoire de l'enseignant de mathématiques             |
|Médiation scientifique|Informations sur les évenements, le milieu, les ressources,...|
